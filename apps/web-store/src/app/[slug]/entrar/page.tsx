      ...
      <div className="mx-auto max-w-xl px-4 py-6">
        <div className="bg-white rounded-2xl border p-6 space-y-5">
          ...
          <div className="text-center text-sm text-muted-foreground">
            Não tem conta?{' '}
            <Link href={`/${slug}/criar-conta?redirect=${encodeURIComponent(redirect)}`} className="text-primary font-medium hover:underline">
              Criar conta
            </Link>
          </div>
          <Link href={`/${slug}`} className="block text-center text-xs text-muted-foreground hover:underline">
